  ...
  return (
    ...
    >
      <div className=" xl:flex">
        ...
        <div className="space-y-4 pt-20  border-2 border-green-600 xl:float-left ">
          <div className="   flex justify-center items-center  text-white ">
            <h3 className="text-[16px] font-barlow-condensed md:text-[20px] md:pr-[500px]">
          ...
          <div className="flex overflow-x-hidden w-full ">
            {planets.map((planet, index) => (
              ...
              >
                <img
                  className="w-[170px] md:w-[300px]  md:h-[300px]"
                  src={planet.img}
        ...
        <div className="border-2 border-pink-500">
          <div className="space-y-4  ">
            <div className="text-white flex justify-center text-[14px] font-barlow-condensed space-x-4 pt-[10px] md:pt-0] xl:pt-[150px] xl:pr-[180px] ">
              <div className=" flex space-x-[30px] md:font-barlow-condensed md:text-[16px]  md:space-x-[50px] ">
                ...
                >
                  <button class="transition ease-in-out delay-150 bg-transparent hover:-translate-y-1 hover:scale-110 hover:bg-transparent duration-300 ...">
                    MOON
                  </button>
                </div>
            ...
            <div className=" w-full flex  overflow-x-hidden  ">
              <div className="w-full flex-shrink-0 px-4">
                ...
                <div className="  text-white   ">
                  <p
                    className="text-[15px] font-barlow  text-center  md:w-[573px] md:h-[84px] md:text-[16px] md:text-center  md:justify-center
                md:items-center md:ml-[90px] lg:ml-[380px] xl:ml-[30px] xl:pl-7 xl:w-[444px] 
            "
                  >
          ...
          <div className="  text-white  flex flex-col space-y-1  md:inline-grid md:grid-cols-4  ">
